...
import { Accordion, AccordionDetails, Autocomplete, Box, Button, FormControl, MenuItem, Select, 
...
const MovieFilters = ({filters, setFilters, movieGenres, availableRegions, movieProviders,
   handleFetchMovieProviders }) => {
      ...
      <Accordion sx={{mt: "16px"}}>
        ...
        <AccordionDetails>
          ...
          <Button 
            ...
            onClick={handleFetchMovieProviders}
          >
          Search providers
          </Button>
          <ToggleButtonGroup 
